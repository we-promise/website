  ...
  def faq_questions
    [
      ...
      },
      {
        ...
        answer: "Yes, Sure is open source. You can find the source code on <a href='https://github.com/we-promise/website' class='font-medium text-gray-900'>GitHub</a>."
      },
      {
        question: "Can I self-host Sure?",
        answer: "Yes, you can self-host Sure. Please refer to the <a href='https://github.com/we-promise/website' class='font-medium text-gray-900'>GitHub repository</a> for more information."
      }
    ]
  end
end
